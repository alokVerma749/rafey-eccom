...
function Section4() {
  return (
    <div className="flex justify-center items-center gap-10 flex-wrap w-full border-2 p-10 lg:p-20">
      {cardDetails.map((product:any, index:any) => {
        const { name, description, images } = product;
        return (
          <Card
            key={index}
            className="h-[300px] rounded-2xl relative shadow-lg w-full bg-[#c9b3a3] md:w-2/5"
            style={{
