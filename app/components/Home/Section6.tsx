...
function Section6() {
  return (
    <div className="flex-1 flex-col md:flex-row justify-between items-center gap-4 relative pb-10 md:p-10 text-white">
      <Image height={200} width={200} src={image1.src} alt="" className="h-[70vh] md:w-[60vw] w-full my-4" />
      <form className="block md:absolute h-[50vh] right-10 top-20 md:w-5/12 shadow-2xl p-4 border-2 bg-[#f7f4ef] rounded">
